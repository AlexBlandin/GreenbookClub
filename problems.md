...
Extension 2:
  Now, you have N lockers and M rounds, where N and M are not nessesarily the
  same number. Solve the same problem once more.
...
it! Let's introduce Stalin Sort:
  ...
  3. At the end of the algorithm, all numbers should appear consecutively with
  any open spaces appearing at the end of the array.
